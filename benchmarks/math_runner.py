...
def main() -> None:
    ap = argparse.ArgumentParser(description="Run the local public-style math smoke suite")
    ...
    result = run_public_suite("math_public_smoke", cfg, prover, verifier, tokenizer, device, args.checker_plugin, event_logger)
